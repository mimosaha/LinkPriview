 ...
 */
public class DefaultImagePickingStrategy extends BaseImagePickingStrategy {
    ...
    @Override
    public List<String> getImages(Document document, HashMap<String, String> metaTags) {
        List<String> images = getMetaImage(metaTags);
